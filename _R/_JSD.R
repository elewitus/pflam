...
###-------------------------Species to remove ---------------------------------##
## c.f. Venditti et al. supp. mat
liste_rem<-c("Ctenomys_pontifex", "Procyon_minor", "Orthogeomys_hispidus", "Oecomys_speciosus", "Taphozous_melanopogon", "Rhipidomys_nitela",
"Crocidura_raineyi", "Gerbillus_ruberrimus", "Oecomys_flavicans", "Acomys_percivali", "Oecomys_rutilus", "Neotoma_varia", "Procyon_maynardi",
"Artibeus_planirostris", "Aotus_lemurinus", "Calomys_callidus", "Nyctimene_celaeno", "Pappogeomys_bulleri", "Ctenomys_sociabilis",
"Taphozous_philippinensis", "Cryptotis_goodwini", "Thomasomys_paramorum", "Neacomys_tenuipes", "Akodon_sylvanus", "Gerbillus_diminutus",
"Epixerus_wilsoni", "Rhipidomys_caucensis", "Proechimys_albispinus", "Oryzomys_melanotis", "Oryzomys_lamia", "Ctenomys_nattereri",
"Proechimys_steerei", "Crocidura_gueldenstaedtii", "Microtus_umbrosus", "Oryzomys_levipes", "Pseudomys_praeconis", "Paruromys_ursinus",
"Neusticomys_mussoi", "Oxymycterus_hucucha", "Microgale_pulla", "Rhipidomys_venustus", "Lama_pacos", "Crocidura_pasha",
"Hipposideros_sabanus", "Peromyscus_perfulvus", "Proechimys_setosus", "Crocidura_osorio", "Peromyscus_sitkensis", "Oligoryzomys_destructor",
"Bassaricyon_pauli", "Proechimys_hendeei", "Mesoplodon_layardii", "Thalpomys_cerradensis", "Dendrohyrax_arboreus", "Maxomys_alticola",
"Gerbillus_quadrimaculatus", "Proechimys_semispinosus", "Galerella_sanguinea", "Pappogeomys_zinseri", "Suncus_malayanus",
"Maxomys_baeodon", "Thomasomys_pyrrhonotus", "Clethrionomys_sikotanensis", "Bassaricyon_lasius", "Mastomys_hildebrandtii",
"Crocidura_viaria", "Oligoryzomys_arenalis", "Thomasomys_baeops", "Eliurus_majori", "Thomasomys_cinereus", "Sus_timoriensis",
"Crocidura_suaveolens", "Monodelphis_theresa", "Oryzomys_auriventer", "Peromyscus_oreas", "Oryzomys_kelloggi", "Heteromys_goldmani",
"Mus_kasaicus", "Monodelphis_iheringi", "Rhipidomys_fulviventer", "Coelops_robinsoni", "Orthogeomys_cuniculus", "Pseudomys_fieldi",
"Thomasomys_notatus", "Capra_cylindricornis", "Choeroniscus_intermedius", "Chrotomys_whiteheadi", "Saccolaimus_saccolaimus",
"Echymipera_clara", "Oryzomys_chapmani", "Gerbillus_dasyurus", "Mogera_wogura", "Thomasomys_eleusis", "Myoprocta_acouchy", "Aotus_azarai",
"Oryzomys_gorgasi", "Proechimys_gorgonae", "Peromyscus_melanophrys", "Reithrodontomys_tenuirostris", "Mogera_etigo", "Peromyscus_merriami",
"Callicebus_modestus", "Callicebus_olallae", "Oecomys_paricola", "Oryzomys_polius", "Ctenomys_boliviensis", "Oryzorictes_hova",
"Proechimys_goeldii", "Myospalax_epsilanus", "Lama_guanicoe", "Peromyscus_polius", "Peromyscus_hooperi", "Peromyscus_gymnotis",
"Mesomys_leniceps", "Eubalaena_glacialis", "Proechimys_amphichoricus", "Aotus_brumbacki", "Mazama_nana", "Capra_caucasica",
"Coelops_hirsutus", "Proechimys_gularis", "Nyctimene_aello", "Reithrodontomys_sumichrasti", "Neotoma_nelsoni", "Muntiacus_crinifrons",
"Cryptotis_magna", "Apomys_abrae", "Tupaia_longipes", "Melonycteris_aurantius", "Dicrostonyx_groenlandicus", "Oryzorictes_talpoides",
"Scotomanes_emarginatus", "Thomasomys_taczanowskii", "Mogera_tokudae", "Crocidura_fumosa", "Ctenomys_azarae", "Crocidura_religiosa",
"Chiropodomys_pusillus", "Peromyscus_zarhynchus", "Melonycteris_woodfordi", "Aonyx_congicus", "Phyllotis_haggardi", "Cephalophus_harveyi",
"Thalpomys_lasiotis", "Akodon_mollis", "Tupaia_montana", "Oxymycterus_angularis", "Dipodomys_venustus", "Euneomys_fossor",
"Dama_mesopotamica", "Crocidura_elgonius", "Rhipidomys_scandens", "Peromyscus_melanurus", "Rhinolophus_keyensis", "Monodelphis_osgoodi",
"Peromyscus_winkelmanni", "Mydaus_javanensis", "Proechimys_bolivianus", "Peromyscus_spicilegus", "Moschus_chrysogaster",
"Paruromys_dominator", "Crocidura_ultima", "Crocidura_batesi", "Pipistrellus_babu", "Crocidura_silacea", "Conepatus_leuconotus",
"Microryzomys_minutus", "Maxomys_ochraceiventer", "Hipposideros_schistaceus", "Alticola_stracheyi", "Dicrostonyx_rubricatus",
"Amblysomus_iris", "Sus_cebifrons", "Ctenomys_perrensis", "Rhinolophus_swinnyi", "Microgale_parvula", "Sus_heureni", "Melomys_rufescens",
"Rhinolophus_arcuatus", "Callicebus_oenanthe", "Habromys_simulatus", "Gerbillus_andersoni", "Dicrostonyx_kilangmiutak", "Thomasomys_daphne",
"Acomys_kempi", "Gerbillus_allenbyi", "Aonyx_capensis", "Peromyscus_ochraventer", "Eliurus_penicillatus", "Neotoma_goldmani",
"Crocidura_zimmeri", "Proechimys_oris", "Neusticomys_peruviensis", "Thomasomys_cinereiventer", "Tylomys_bullaris", "Alticola_stoliczkanus",
"Tupaia_splendidula", "Tupaia_palawanensis", "Rhinolophus_coelophyllus", "Pappogeomys_alcorni", "Tupaia_picta", "Pipistrellus_javanicus",
"Thomasomys_rosalinda", "Scolomys_melanops", "Rhinolophus_anderseni", "Proechimys_myosuros", "Cercopithecus_cephus",
"Mesoplodon_ginkgodens", "Crocidura_nigeriae", "Chiropodomys_major", "Oryzomys_ratticeps", "Mastomys_natalensis",
"Heteromys_desmarestianus", "Canis_rufus", "Proechimys_urichi", "Aotus_hershkovitzi", "Ctenomys_sericeus", "Crocidura_minuta",
"Orthogeomys_grandis", "Clethrionomys_rufocanus", "Maxomys_panglima", "Akodon_torques", "Oryzomys_intermedius",
"Reithrodontomys_microdon", "Hipposideros_doriae", "Tylomys_tumbalensis", "Crocidura_monax", "Proechimys_brevicauda",
"Chinchilla_brevicaudata", "Phyllotis_bonaeriensis", "Tupaia_dorsalis", "Proechimys_oconnelli", "Conepatus_mesoleucus", "Proechimys_magdalenae",
"Microtus_obscurus", "Rheomys_thomasi", "Heterohyrax_brucei", "Ovis_vignei", "Echymipera_echinista", "Procyon_lotor", "Canis_lupus",
"Chiropodomys_muroides", "Perognathus_parvus", "Amblysomus_hottentotus", "Mogera_robusta", "Rhipidomys_austrinus", "Myotis_milleri",
"Gerbillus_campestris", "Cercopithecus_erythrogaster", "Crocidura_montis", "Myotis_evotis", "Gerbillus_percivali", "Neotoma_albigula",
"Akodon_orophilus", "Oecomys_cleberi", "Graphiurus_kelleni", "Microtus_guatemalensis", "Crocidura_russula", "Mus_musculoides",
"Sus_philippensis", "Oligoryzomys_andinus", "Bibimys_torresi", "Suncus_varilla", "Microtus_arvalis", "Perognathus_xanthanotus",
"Proechimys_poliopus", "Mazama_bricenii", "Thomasomys_silvestris", "Orthogeomys_lanius", "Calomys_hummelincki", "Cephalophus_natalensis",
"Oryzomys_buccinatus", "Bibimys_chacoensis", "Mesomys_stimulax", "Phyllotis_wolffsohni", "Melomys_gracilis", "Proechimys_quadruplicatus",
"Dama_dama", "Neotoma_palatina", "Oryzomys_balneator", "Thomasomys_hylophilus", "Rhinolophus_simplex", "Oxymycterus_akodontius",
"Gerbillus_pusillus", "Crocidura_jacksoni", "Heterohyrax_antineae", "Oryzomys_intectus", "Saccolaimus_pluto", "Hipposideros_lankadiva",
"Oecomys_superans", "Artibeus_jamaicensis", "Oligoryzomys_griseolus", "Oryzomys_hammondi", "Thomasomys_ladewi", "Histiotus_macrotus",
"Dasyprocta_guamara", "Muntiacus_gongshanensis", "Thomasomys_ischyurus", "Aotus_miconax", "Ovis_aries", "Thomasomys_oreas",
"Thomasomys_gracilis", "Peromyscus_guatemalensis", "Proechimys_decumanus", "Habromys_chinanteco", "Gerbillus_bonhotei", "Myotis_altarium",
"Mesomys_obscurus", "Echimys_macrurus", "Proechimys_hoplomyoides", "Chrotomys_mindorensis", "Rhipidomys_wetzeli", "Peromyscus_simulus",
"Proechimys_simonsi", "Crocidura_turba", "Mesoplodon_carlhubbsi", "Thomasomys_rhoadsi", "Proechimys_warreni", "Mydaus_marchei",
"Microryzomys_altissimus", "Oryzomys_bolivaris", "Dipodomys_elephantinus", "Graphiurus_parvus", "Oryzomys_yunganus", "Melanomys_zunigae",
"Apodemus_hermonensis", "Aotus_infulatus", "Oecomys_roberti", "Galerella_swalius", "Myoprocta_exilis", "Proechimys_mincae",
"Scotomanes_ornatus", "Scolomys_ucayalensis", "Melanomys_robustulus", "Ctenomys_colburni", "Dasyprocta_cristata", "Rheomys_mexicanus",
"Thomasomys_kalinowskii", "Pseudomys_johnsoni", "Oxymycterus_hiska", "Oecomys_trinitatis", "Chiropodomys_calamianensis",
"Oryzomys_albigularis", "Lama_glama", "Habromys_lophurus", "Apodemus_arianus", "Proechimys_cayennensis", "Mogera_kobeae", "Epixerus_ebii",
"Apomys_sacobianus", "Apomys_insignis", "Peromyscus_bullatus", "Thomasomys_incanus", "Procyon_insularis", "Rhipidomys_ochrogaster",
"Oligoryzomys_magellanicus", "Akodon_subfuscus", "Myospalax_psilurus", "Rhipidomys_latimanus", "Apodemus_flavicollis",
"Dendrohyrax_validus", "Mesoplodon_bidens", "Thomasomys_monochromos", "Pappogeomys_fumosus", "Sus_celebensis", "Neotoma_angustapalata",
"Euneomys_petersoni", "Proechimys_chrysaeolus", "Pipistrellus_tenuis", "Reithrodontomys_chrysopsis", "Pipistrellus_mimus",
"Pipistrellus_peguensis", "Crocidura_grandiceps", "Oecomys_rex", "Dasyprocta_kalinowskii", "Oxymycterus_nasutus", "Crocidura_nanilla",
"Moschus_fuscus", "Rhipidomys_couesi", "Oecomys_phaeotis", "Pseudomys_laborifex", "Crocidura_niobe", "Graphiurus_olga", "Apomys_hylocoetes",
"Echimys_unicolor", "Apomys_datae", "Calomys_boliviae", "Choeroniscus_minor", "Eubalaena_australis", "Neacomys_spinosus", "Akodon_surdus",
